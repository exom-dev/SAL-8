...
SAL8_API void* sal8_mem_expand(void* ptr, size_t* size, size_t unitSize, const char* file, uint32_t line);
SAL8_API void  sal8_mem_free(void* ptr, const char* file, uint32_t line);
SAL8_API void  sal8_mem_panic();
